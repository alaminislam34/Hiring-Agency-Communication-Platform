  ...
  return (
    <div className={`w-[90%] mx-auto my-10 ${nunito.className}`}>
      ...
      <div className="text-center py-6">
        ...
        <h2 className="text-xl font-semibold text-[#084049] py-2">
          We Do Things Differently...
        </h2>
        <p className={`mt-2 text-center ${nunito.className} font-semibold`}>
          We don’t just connect people to jobs — we craft futures. Our approach
          is personal, precise, and performance-driven. When you work with us,
      ...
      <div className="my-12">
        ...
        <div className="text-center my-8">
          ...
          <p
            className={`mt-2 text-center w-full md:w-[90%] lg:w-[80%] xl:w-[70%] ${nunito.className} mx-auto font-semibold`}
          >
            We’re not just a team — we’re a collective of bold thinkers,
            builders, and connectors. Our values drive everything we do, from
            how we collaborate internally to how we deliver real, lasting
            results for our clients. These principles guide our mission to
            revolutionize hiring, one meaningful match at a time.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-4 ">
          ...
          <div className="text-center bg-[#084049] rounded-3xl shadow-md p-4 text-white">
            ...
            <p className="text-center m-4">
              Whether your team is small or scaling, our shared inboxes ensure
              every recruiter stays aligned. No missed emails, no confusion —
              just smooth collaboration and faster placements.
            </p>
          </div>
          {/* item-2 */}
          <div className="text-center bg-[#084049] rounded-3xl shadow-md p-4 text-white">
            ...
            <p className="text-center m-4">
              Speed is key in recruitment. Our system empowers you to deliver
              prompt, professional responses to candidates — helping you secure
              top talent before the competition does.
            </p>
          </div>
          {/* item-3 */}
          <div className="text-center bg-[#084049] rounded-3xl shadow-md p-4 text-white">
            ...
            <p className="text-center m-4">
              Stay in control of your recruitment funnel. With real-time reports
              and insights, you can monitor progress, measure recruiter
              performance, and refine your hiring strategy.
            </p>
          </div>
          {/* item-4 */}
          <div className="text-center bg-[#084049] rounded-3xl shadow-md p-4 text-white">
            ...
            <p className="text-center m-4">
              We help you stay connected with applicants through timely updates
              and personalized interactions — turning every application into a
              relationship and every touchpoint into trust.
            </p>
          </div>
          {/* item-5 */}
          <div className="text-center bg-[#084049] rounded-3xl shadow-md p-4 text-white">
            ...
            <p className="text-center m-4">
              Use what you love. Our platform integrates seamlessly with your
              ATS, calendars, and communication tools — so your team can recruit
              smarter, not harder.
            </p>
          </div>
          {/* item-6 */}
          <div className="text-center bg-[#084049] rounded-3xl shadow-md p-4 text-white">
            ...
            <p className="text-center m-4">
              At the heart of everything we do is people. We believe in hiring
              with intention — helping businesses grow and individuals thrive
              through meaningful career connections.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="mb-12">
        ...
        <div className="text-center my-10">
          ...
          <h2 className="text-3xl font-bold text-[#084049]">Meet Our Team</h2>
          <p
            className={`mt-2 text-center w-full md:w-[90%] lg:w-[80%] xl:w-[60%]  mx-auto font-semibold`}
          >
