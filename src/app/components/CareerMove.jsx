        ...
        <div className="w-1/2">
          ...
          <ul className="mt-4 space-y-4 text-gray-700">
            <li className="flex items-start gap-3">
              ...
              <span>Get instant job recommendations tailored to your skills and goals</span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircleIcon className="w-6 h-6 text-green-500" />
              <span>Gain exposure to a range of companies and job types: fully remote, hybrid or on-site, and contract or permanent</span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircleIcon className="w-6 h-6 text-green-500" />
              <span>Access competitive pay, benefits, and free online training and development</span>
            </li>
          </ul>
