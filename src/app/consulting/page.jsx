  ...
  return (
    <section className="bg-gray-50 py-16 px-6">
      <div className="max-w-6xl mx-auto text-center mb-12">
        <h2 className="text-4xl font-bold text-[#084049]">Consulting Pricing Packages</h2>
        <p className="mt-4 text-gray-600 text-lg">
          Choose a plan that fits your hiring needs. Get access to the best talent with JobHive.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
        ...
        <motion.div whileHover={{ scale: 1.05 }}>
          <Card className="rounded-2xl shadow-md border-teal-100 hover:shadow-lg transition-all duration-300">
            <h3 className="text-2xl font-semibold text-[#084049] mb-2">Basic</h3>
            <p className="text-4xl font-bold text-[#084049]">$49</p>
            <p className="text-gray-500 mb-4">Ideal for small teams & startups</p>
        ...
        <motion.div whileHover={{ scale: 1.05 }}>
          <Card className="rounded-2xl shadow-md border-teal-100 hover:shadow-lg transition-all duration-300">
            <h3 className="text-2xl font-semibold text-[#084049] mb-2">Enterprise</h3>
